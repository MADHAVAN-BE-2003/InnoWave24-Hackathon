...
separate_model = separator.from_hparams(source="speechbrain/sepformer-wsj02mix")

# Load the enhancement model
enhancement_model = separator.from_hparams(source="speechbrain/sepformer-whamr-enhancement")
